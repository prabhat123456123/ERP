  ...
  messenger: async (message, phone, DLT) => {
    try {
      if (process.env.NODE_ENV !== "production") {
        ...
        const url = `http://api.msg91.com/api/sendhttp.php?route=4&sender=CBUCKT&mobiles=91${phone}&authkey=172372Anbk2vu0jf5ce270fe&message=${msg}&response=json&DLT_TE_ID=${DLT}`;
        console.log(url);
        http
